...
if (CUDD_HOME)
    ...
    find_library(Cudd_STATIC_LIB_DIR NAMES libcudd.a PATHS "${CUDD_HOME}/include" NO_DEFAULT_PATH)
    find_library(Cudd_SHARED_LIB_DIR NAMES libcudd.so PATHS "${CUDD_HOME}/include" NO_DEFAULT_PATH)
else ()
